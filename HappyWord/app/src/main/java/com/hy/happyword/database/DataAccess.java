...
import com.hy.happyword.activitys.ImportBook;
...
public class DataAccess {
    ...
    public static int NumOfAttention;  //生词本的词数
    ...
    /**
     * 查询词库
     * @param selection 查询条件（where语句）
     * @param selectionArgs  where 中包含的“？”，通配符
     * @return
     */
